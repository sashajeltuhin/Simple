...
//var launch = function(cont){
//    console.log("launching");
//    var d = $('<div ng-app="cart" ng-controller="cartctrl"><div cart-parms cart-srch="#btnSearch" cart-clr="btnClearForm" app-Type="OMS" cart_zipval="0" cart-zip="txtZip" ex-prod="DTV 1Premier pakage" ex-price="114.99"></div><div id="bv_cart_cont" class="container appBody" style="display: none" ng-include src="' + "'" + 'http://localhost/templ/first.html' + "'" + '"></div></div>');
//    d.insertAfter(cont);
//    angular.bootstrap(d, ['cart'])
//    var w = cont.width();
//    d.width(w);
